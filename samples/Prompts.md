Copy-ready format below. Each block is one prompt you can copy directly.
...
If you want, I can also paste these as a single plain .txt block with === PROMPT 01 === separators so you can save once and copy linearly.
